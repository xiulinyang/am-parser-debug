...
class RuleIndexField(Field):
    ...
    def index(self, vocab: Vocabulary):
        ...
        if "@@UNKNOWN@@" not in vocab.get_token_to_index_vocabulary(namespace=self.supertag_namespace):
            vocab.add_token_to_namespace ("@@UNKNOWN@@", namespace=self.supertag_namespace)
