    ...
    def batch_loss(self, batch_group: List[TensorDict], for_training: bool) -> torch.Tensor:
        ...
        try:
            ...
            if for_training:
                ...
                print(self.model.get_regularization_penalty())
                print(output_dict.keys())
                print(output_dict['arc_loss'])
                print(output_dict['lexlabel_loss'])
...
class TrainerPieces(NamedTuple):
    ...
    def from_params(params: Params, serialization_dir: str, recover: bool = False) -> 'TrainerPieces':
        ...
        if "@@UNKNOWN@@" not in vocab.get_token_to_index_vocabulary(namespace="ner_labels"):
            vocab.add_token_to_namespace("@@UNKNOWN@@", namespace="ner_labels") 
