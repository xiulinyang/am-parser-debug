...
#============FILEPATHS==============
local train_zip_path = "./output/train.zip";  
local dev_zip_path = "./output/dev.zip";
local validation_amconll_path = "./output/drt_dev.amconll";
local validation_gold_path = "./output/gold_dev.txt";
