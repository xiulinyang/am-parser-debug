...
#============FILEPATHS==============
local train_zip_path = "./train.zip";  
local dev_zip_path = "./boxless_sbn2/dev.zip";
local validation_amconll_path = "./boxless_sbn2/drt_dev.amconll";
local validation_gold_path = "./boxless_sbn2/gold_dev.txt";
