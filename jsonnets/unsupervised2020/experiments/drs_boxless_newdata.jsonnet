...
#============FILEPATHS==============
local train_zip_path = "./boxless/train.zip";  
local dev_zip_path = "./boxless/dev.zip";
local validation_amconll_path = "./boxless/drt_dev.amconll";
local validation_gold_path = "./boxless/gold_dev.txt";
