...
#============FILEPATHS==============
local train_zip_path = "./scopeless5/train.zip";  
local dev_zip_path = "./scopeless5/dev.zip";
local validation_amconll_path = "./scopeless5/drt_dev.amconll";
local validation_gold_path = "./scopeless5/gold_dev.txt";
