...
#============FILEPATHS==============
local train_zip_path = "./scopeless_exp1/train.zip";  
local dev_zip_path = "./scopeless_exp1/dev.zip";
local validation_amconll_path = "./scopeless_exp1/drt_dev.amconll";
local validation_gold_path = "./scopeless_exp1/gold_dev.txt";
