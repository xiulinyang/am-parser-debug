...
#============FILEPATHS==============
local train_zip_path = "./am-tools/am-tools/data/output/train.zip";  
local dev_zip_path = "./am-tools/am-tools/data/output/dev.zip";
local validation_amconll_path = "./am-tools/am-tools/data/output/drt_dev.amconll";
local validation_gold_path = "./input_new_data/gold_dev.txt";
