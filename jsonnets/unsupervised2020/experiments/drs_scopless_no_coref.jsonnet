...
#============FILEPATHS==============
local train_zip_path = "./scopeless/train.zip";  
local dev_zip_path = "./scopeless/dev.zip";
local validation_amconll_path = "./scopeless/drt_dev.amconll";
local validation_gold_path = "./scopeless/gold_dev.txt";
