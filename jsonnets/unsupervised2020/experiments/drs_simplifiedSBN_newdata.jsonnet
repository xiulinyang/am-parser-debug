...
#============FILEPATHS==============
local train_zip_path = "./simplifiedSBN/train.zip";  
local dev_zip_path = "./simplifiedSBN/dev.zip";
local validation_amconll_path = "./simplifiedSBN/drt_dev.amconll";
local validation_gold_path = "./simplifiedSBN/gold_dev.txt";
