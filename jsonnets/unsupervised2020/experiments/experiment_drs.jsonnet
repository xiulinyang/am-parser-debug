...
#============FILEPATHS==============
local train_zip_path = "./experiment_output/train.zip";  
local dev_zip_path = "./experiment_output/dev.zip";
local validation_amconll_path = "./experiment_output/drt_dev.amconll";
local validation_gold_path = "./experiment_output/gold_dev.txt";
...
local formalism_config = import '../formalisms/experiment_drs.libsonnet';
