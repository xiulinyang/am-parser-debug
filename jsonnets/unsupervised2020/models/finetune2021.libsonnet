...
local dropout = 0.35;  # dropout rate in the Bi-LSTM
local recurrent_dropout_probability = 0.4;  # dropout rate for recurrent part of decoder
local dropout_mlp = 0.3;  # dropout rate in the final supertagger and edge model hidden layers
...
function(batch_size, num_epochs, patience, task, evaluation_command, validation_metric, validation_amconll_path, validation_gold_path, test_triples_amconll_gold_suffix) {
	...
	"model": {
        "type": "from_archive",
    "archive_file": "/am-parser-app/output_model_scopeless_new_data/model.tar.gz",
